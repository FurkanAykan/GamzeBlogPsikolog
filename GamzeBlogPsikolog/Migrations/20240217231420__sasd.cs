            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReplyCommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReplyCommentUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReplyCommentStatus = table.Column<bool>(type: "bit", nullable: false),
                    ReplyCommentContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReplyCommentEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReplyCommentImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReplyCreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CommentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
