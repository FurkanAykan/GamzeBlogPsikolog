...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamzeBlogPsikolog.Entity.About", b =>
                {
            ...
            modelBuilder.Entity("GamzeBlogPsikolog.Entity.BlogPost", b =>
                {
            ...
            modelBuilder.Entity("GamzeBlogPsikolog.Entity.Comment", b =>
                {
            ...
            modelBuilder.Entity("GamzeBlogPsikolog.Identity.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GamzeBlogPsikolog.Entity.Comment", b =>
                {
                    b.HasOne("GamzeBlogPsikolog.Entity.BlogPost", "BlogPost")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("GamzeBlogPsikolog.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("GamzeBlogPsikolog.Identity.AppUser", null)
                        .WithMany()
